...
public static class SWT
{
    ...
    // Key codes
    // KEYCODE_BIT marks special (non-ASCII) key codes like F1, arrows, etc.
    public const int KEYCODE_BIT = 1 << 24; // 0x1000000
    public const int ARROW_UP = KEYCODE_BIT | 1;
    public const int ARROW_DOWN = KEYCODE_BIT | 2;
    public const int ARROW_LEFT = KEYCODE_BIT | 3;
    public const int ARROW_RIGHT = KEYCODE_BIT | 4;
    public const int PAGE_UP = KEYCODE_BIT | 5;
    public const int PAGE_DOWN = KEYCODE_BIT | 6;
    public const int HOME = KEYCODE_BIT | 7;
    public const int END = KEYCODE_BIT | 8;
    public const int INSERT = KEYCODE_BIT | 9;
    public const int F1 = KEYCODE_BIT | 10;
    public const int F2 = KEYCODE_BIT | 11;
    public const int F3 = KEYCODE_BIT | 12;
    public const int F4 = KEYCODE_BIT | 13;
    public const int F5 = KEYCODE_BIT | 14;
    public const int F6 = KEYCODE_BIT | 15;
    public const int F7 = KEYCODE_BIT | 16;
    public const int F8 = KEYCODE_BIT | 17;
    public const int F9 = KEYCODE_BIT | 18;
    public const int F10 = KEYCODE_BIT | 19;
    public const int F11 = KEYCODE_BIT | 20;
    public const int F12 = KEYCODE_BIT | 21;
    public const int CR = 13; // Carriage return
    public const int LF = 10; // Line feed
    public const int TAB = 9;  // Tab
